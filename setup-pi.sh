...
ssh $SSH_PI "sudo apt-get update && sudo apt-get install libjpeg8-dev graphicsmagick-imagemagick-compat darkice icecast2 screen libmp3lame-dev avahi-daemon libasound2-dev wpasupplicant && mkdir raspbaby"
